  ...
  return (
    <KeyboardAvoidingView style={styles.container} >
      <View style={{ backgroundColor: grey0 }} >
        <Text style={[styles.txtJudul, { fontFamily: "Poppins-SemiBold", fontSize: hp('4%') }]}>Login User</Text >
        <View style={[styles.Form, { alignSelf: "stretch" }]}>
          ...
          <View style={styles.inForm}>
            ...
            <TextInput style={{ borderColor: blue, borderWidth: 2, borderRadius: 10, fontSize: hp('2.5%') }} placeholder="Isikan username" onChangeText={val => setUsername(val)}>
          ...
          <TouchableOpacity style={[styles.input,{backgroundColor: blue}
          ]} onPress={ActionLogin}>
